...
namespace Exerc_Entity_Scaffold.Controllers
{
    public class ConfiguracoesController : Controller
    {
        private readonly ExercContexto _context;

        public ConfiguracoesController(ExercContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Configuracoes != null ? 
                          ...
                          Problem("Entity set 'ExercContexto.Configuracoes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DiasLocacao")] Configuracao configuracao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DiasLocacao")] Configuracao configuracao)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ExercContexto.Configuracoes'  is null.");
            }
            var configuracao = await _context.Configuracoes.FindAsync(id);
            if (configuracao != null)
            {
